...
CONFIG_FILE = os.path.join(ROOT_DIRECTORY, 'cf.db')
LEGACY_CONFIG_FILE = os.path.join(ROOT_DIRECTORY, 'config.db')
...
PROJECT_CONFIG = "config.db"
PROJECT_RESOURCES = "resources.db"
